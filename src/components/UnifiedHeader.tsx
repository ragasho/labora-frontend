...
export function UnifiedHeader({
    ...
    return (
        <header className={`sticky top-0 z-50 bg-gradient-to-b ${serviceColors.gradient} border-b shadow-sm`}>
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-gray-500 truncate">
                                    {selectedLocation ? [selectedLocation.flatInfo, selectedLocation.fullAddress].filter(Boolean).join(', ') : "Choose Location"}
                                </span>
                            </div>
                        </Button>
                    )}
